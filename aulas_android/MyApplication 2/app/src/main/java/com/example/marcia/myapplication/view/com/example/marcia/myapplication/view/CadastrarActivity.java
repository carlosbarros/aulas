    ...
    protected  void Salvar_onClick(){
        ...
        if(editTextEmail.getText().toString().trim().equals("")){
            ...
            switch (LoginActivity.tipo){
                case 1://BD
                    new ContatoControleBD(this).Salvar(pessoaModel);
                    break;
                case 2: //List
                    int id = LoginActivity.controleContatos.SelecionarTodos().size()+1;
                    pessoaModel.setCodigo(id);
                    LoginActivity.controleContatos.adicionar(pessoaModel);
                    break;
                case 3://Servico
                    new ContatoControleServico(this).Salvar(pessoaModel);
                    break;
            }
            /*MENSAGEM DE SUCESSO!*/
